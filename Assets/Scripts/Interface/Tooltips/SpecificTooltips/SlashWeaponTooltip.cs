...
public class SlashWeaponTooltip : MonoBehaviour
{
    ...
    {
        if (playerLevelsScript.SlashLevel >= itemsStats.EquipRequirement) //If you have req, don't show it
        {
        ...
        {
            requirements.text = $"<color=red>Requires Slash Level: {itemsStats.EquipRequirement}</color>";
        }
    }

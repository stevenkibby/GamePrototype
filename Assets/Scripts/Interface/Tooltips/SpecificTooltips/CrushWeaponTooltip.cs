...
public class CrushWeaponTooltip : MonoBehaviour
{
    ...
    {
        if (playerLevelsScript.CrushLevel >= itemsStats.EquipRequirement) //If you have req, don't show it
        {
        ...
        {
            requirements.text = $"<color=red>Requires Crush Level: {itemsStats.EquipRequirement}</color>";
        }
    }
